...
export default function menu () {
    return(
        <div className="">
              ...
              <div className=" gap-2 p-3 w-[700px] mx-auto xl:mx-10">
                ...
                <div className="">
                  <div className="flex justify-between ">
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Alder Grilled Chinook Salmon</h5>
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">32$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Toasted French bread topped with romano, cheddar</p>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
                  <div className="mt-4 border-[2px] border-[#E0E0E0] border-dashed "></div>
                </div>
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Berries and creme tart</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">43$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Gorgonzola, ricotta, mozzarella, taleggio</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">700 CAL</p>
                  <div className="mt-4 border-[2px] border-[#E0E0E0] border-dashed "></div>
                </div>
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Tormentoso Bush Pizza Pintoage</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">14$</h5>
                  </div>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">Ground cumin, avocados, peeled and cubed</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">1000 CAL</p>
                  <div className="mt-4 border-[2px] border-[#E0E0E0] border-dashed "></div>
                </div>
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Spicy Vegan Potato Curry</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">35$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Spreadable cream cheese, crumbled blue cheese</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
                  <div className="mt-4 border-[2px] border-[#E0E0E0] border-dashed "></div>
                </div>
              </div>
            ...
            <div className="xl:flex justify-center gap-10 mt-16 mx-auto xl:mx-72 ">
              ...
              <div className=" gap-2 p-3 w-[700px] mx-auto xl:mx-10">
                ...
                <div className="">
                  <div className="flex justify-between ">
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Optic Big Breakfast Combo Menu</h5>
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">32$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Toasted French bread topped with romano, cheddar</p>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Cashew Chicken With Stir-Fry</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">43$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Gorgonzola, ricotta, mozzarella, taleggio</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">700 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]"> Vegetables & Green Salad</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">14$</h5>
                  </div>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">Ground cumin, avocados, peeled and cubed</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">1000 CAL</p>
           ...
           <div className="xl:flex justify-center gap-10 mt-32 mx-auto xl:mx-72 ">
            <div className="xl:hidden sm:grid place-content-center">
                  <Image src={image34} alt="coffee cup" className="w-[25px] h-[25px]" />
              ...
              <div className=" gap-2 p-3 w-[700px] mx-auto xl:mx-10">
                ...
                <div className="">
                  <div className="flex justify-between ">
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Fig and lemon cake</h5>
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">32$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Toasted French bread topped with romano, cheddar</p>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Creamy mascarpone cake</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">43$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Gorgonzola, ricotta, mozzarella, taleggio</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">700 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Pastry, blueberries, lemon juice</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">14$</h5>
                  </div>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">Ground cumin, avocados, peeled and cubed</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">1000 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Pain au chocolat</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">35$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Spreadable cream cheese, crumbled blue cheese</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
            ...
            <div className="xl:flex justify-center gap-10 mt-16 mx-auto xl:mx-72 ">
              ...
              <div className=" gap-2 p-3 w-[700px] mx-auto xl:mx-10">
                ...
                <div className="">
                  <div className="flex justify-between ">
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Caffè macchiato</h5>
                    <h5 className=" font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">32$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Toasted French bread topped with romano, cheddar</p>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Aperol Spritz Capacianno</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">43$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Gorgonzola, ricotta, mozzarella, taleggio</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">700 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Caffe Latte Campuri</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">14$</h5>
                  </div>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">Ground cumin, avocados, peeled and cubed</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">1000 CAL</p>
                ...
                <div className="">
                  <div className="flex justify-between">
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#333333] hover:text-[#ff9f0d]">Tormentoso BushTea Pintoage</h5>
                    <h5 className="font-[helvetica] font-bold text-[24px] text-[#ff9f0d]">35$</h5>
                  </div>
                  <p className=" font-[helvetica] text-[16px] text-[#333333]">Spreadable cream cheese, crumbled blue cheese</p>
                  <p className="font-[helvetica] text-[16px] text-[#333333]">560 CAL</p>
